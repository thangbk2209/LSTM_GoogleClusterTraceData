...
for sliding in sliding_widow:
	for batch_size in batch_size_array:
		...
		Real_df = read_csv('/home/nguyen/LSTM_GoogleTraceData/data/Fuzzy_data_sampling_617685_metric_10min_datetime_origin.csv', header=None, index_col=False, names=colnames, engine='python')
		Pred_TestInverse_df = read_csv('./2layer_32-4neu_normalAll/testPredictInverse_sliding=%s_batchsize=%s.csv'%(sliding,batch_size), header=None, index_col=False, engine='python')
		...
		RMSE_df = read_csv('./2layer_32-4neu_normalAll/error_sliding=%s_batchsize=%s.csv'%(sliding,batch_size), header=None, index_col=False, engine='python')
