...
df = read_csv('/mnt/volume/ggcluster/spark-2.1.1-bin-hadoop2.7/thangbk2209/plotTimeSeries/results/data_resource_JobId_6336594489.csv', header=None, index_col=False, names=colnames, usecols=[4], engine='python')
...
plt.savefig('CPUpredict_adam_many2one.png')
pp = PdfPages('predictCPU_adam_many2one.pdf')
pp.savefig()
pp.close()
# plt.show()